...
int main()
{
	...
	cout<<"--------------------------------------------------"<<endl;
   	gotoxy(17,11);
   	cout<<"      |Faculty ->> Dr. Himani Bansal <<-- |\n"<<endl;
   	gotoxy(17,13);
   	cout<<"      >>>----Project Implemented By-----<<<"<<endl;
    gotoxy(22,15);
   	cout<<"      Shikhar Gupta    (9919103219)"<<endl;
   	gotoxy(22,16);
   	cout<<"      Chetan Chaudhary (9919103225)"<<endl;
   	gotoxy(22,17);
   	cout<<"      Prakhar Jauhari  (9919103206)"<<endl;
   	gotoxy(22,18);
   	cout<<"      Manav Choudhary  (9919103222)"<<endl<<endl;
	system("pause");
	system("cls");
	system("color Fc");
	...
	case 1:
        ...
        cin >> admpass;
        if(admpass[0]=='A'&& admpass[1]=='d' && admpass[2]=='m' && admpass[3]=='i' && admpass[4]=='n' && admpass[5]=='@'
           &&admpass[6]=='1'){
                system("cls");
